...
const EventDetail: React.FC<EventDetailProps> = ({ event, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 animate-[fadeIn_0.3s_ease-out]" onClick={onClose}>
      <div
        className="relative max-w-4xl w-full h-[90vh] max-h-[800px] glassmorphism rounded-2xl border-2 border-brand-purple flex flex-col overflow-hidden animate-[fadeInUp_0.5s_ease-out]"
      ...
      >
        ...
        <header className="p-8 border-b border-brand-purple/50 flex flex-col md:flex-row items-center gap-6 animate-[fadeInUp_0.5s_ease-out_0.1s_both]">
          <div className="w-24 h-24 flex-shrink-0 rounded-full bg-brand-dark/50 flex items-center justify-center border-2 border-brand-amber animate-[scaleIn_0.5s_ease-out_0.2s_both]">
        ...
        <div className="flex flex-col flex-grow overflow-y-auto">
          <nav className="flex-shrink-0 border-b border-brand-purple/50 px-8 animate-[fadeInUp_0.5s_ease-out_0.2s_both]">
